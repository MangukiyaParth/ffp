		...
		<div class="center-sign">
			...
			<div class="panel panel-sign">
				...
				<div class="panel-body">
					<div class="msg"></div>
					<form method="post" id="loginform" class="without-otp">
						<div class="form-group mb-lg">
							<label>Email</label>
							<div class="input-group input-group-icon">
								<input name="email" type="email" id="email" placeholder="Enter Email" class="form-control input-lg" />
						...
						<div class="form-group mb-lg">
							...
							<div class="input-group input-group-icon">
								<input name="password" type="password" class="form-control input-lg" placeholder="Enter Password" />
								<span class="input-group-addon">
									<span class="icon icon-lg">
