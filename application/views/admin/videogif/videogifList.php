    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span class="">Videogif List</span></li>
            </ol>
        ...
        <div class="col-xs-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title"><a href="javascipt:void(0);"><i class="fa fa-list" aria-hidden="true"></i></a> &nbsp;Videogif List (<?php echo count($list); ?>)
                        <a href="<?php echo ADMIN_URL . 'videogif/addvideogif/' ?>" class="right mb-xs mt-xs mr-xs btn padheader btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> <span>
                                &nbsp;Add Videogif</span></a>
                    </h2>
                </header>
                ...
                <div class="panel-body">
                    <button style="margin-bottom: 10px" class="btn btn-danger delete_all" data-url="<?php echo base_url("admin/videogif/deleteAllvideogif"); ?>">All Selected</button>
                    <div>
                        <!-- table-responsive -->
                        <table class="table table-bordered table-striped mb-none" id="videogifListTable">
                            <thead>
                                <tr>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form class="form-horizontal form-bordered" method="post" action="<?php echo base_url("admin/videogif/allEditUpdate");?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Edit Videogif</h4>
                </div>
