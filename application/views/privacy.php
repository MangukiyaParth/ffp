...
<html lang="en" class="fullscreen-bg">
    ...
    <head>
        <title>Privacy Policy - Free Festive Post</title>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

        <meta name="description" content="Free Festive Post">
        <meta name="author" content="Free Festive Post">
        <meta property="og:image" content="http://freefestivalpost.in/assets/user/images/logo.png">
        <meta property="og:url" content="https://freefestivalpost.in/">
        <!-- CSS -->
        ...
        <div class="container">
            <section class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p>Free Festive Post built the <b>Free Festive Post</b> app as a Free app.
                        This
                        SERVICE is
                        provided by Free Festive Post at no cost and is intended for use as is.</p>
                    ...
                    <p>The terms used in this Privacy Policy have the same meanings as in our Terms
                        and
                        Conditions, which is accessible at <b>Free Festive Post</b> unless
                        otherwise
                        defined in
                    ...
                    <p>For a better experience, while using our Service, we may require you to
                        provide
                        us
                        with certain personally identifiable information, including but not limited
                        to
                        Photos,media, files, Send and view SMS,Make and manage phone calls. The
                        information
                    ...
                    <p>We want to inform you that whenever you use our Service, in a case of an
                        error in
                        the
                        app we collect data and information (through third party products) on your
                        phone
                        called Log Data. This Log Data may include information such as your device
                        Internet
                        Protocol (“IP”) address, device name, operating system version, the
                        configuration of
                        the app when utilizing our Service, the time and date of your use of the
                        Service,
                    ...
                    <p>We want to inform users of this Service that these third parties have access
                        to
                        your
                        Personal Information. The reason is to perform the tasks assigned to them on
                        our
                        behalf. However, they are obligated not to disclose or use the information
                        for
                        any
                        other purpose.</p>
                    ...
                    <p>Cookies are files with a small amount of data that are commonly used as
                        anonymous
                        unique identifiers. These are sent to your browser from the websites that
                        you
                        visit
                        and are stored on your device's internal memory.</p>

                    <p>This Service does not use these “cookies” explicitly. However, the app may
                        use
                        third
                        party code and libraries that use “cookies” to collect information and
                        improve
                        their
                    ...
                    <p>This Service may contain links to other sites. If you click on a third-party
                        ...
                        operated
                        by us. Therefore, we strongly advise you to review the Privacy Policy of
                        these
                    ...
                    <p>We value your trust in providing us your Personal Information, thus we are
                        striving
                        to use commercially acceptable means of protecting it. But remember that no
                        method
                    ...
                    <p>These Services do not address anyone under the age of 13. We do not knowingly
                        collect
                        ...
                        immediately
                        delete this from our servers. If you are a parent or guardian and you are
                        aware
                        that
                        your child has provided us with personal information, please contact us so
                        that
                        we
                    ...
                    <p>If you have any questions or suggestions about our Privacy Policy, do not
                        hesitate to
                        contact us on contact@freefestivalpost.in</p>
                </div>
            </section>
        </div>
        <!-- END WRAPPER -->
